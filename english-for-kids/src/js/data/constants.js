...
export const formDataForCategoriesCard = function() {
    const dataCategoriesArray = [];
    ...
    for (let i = 1; i <= constantNumbers.categoriesNum; i++) {
        ...
        const categoryObj = {
            ...
            image: categories[i].cards[3].image,
            hash: categories[i].hash
        };

        dataCategoriesArray.push(categoryObj);
    }

    return dataCategoriesArray;
